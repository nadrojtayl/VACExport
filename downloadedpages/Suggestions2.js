  ...
  renderElement(name,int, additionalStyle, clickfunctions,elem){
    ...
    render(){
      ...
      <Text
        ...
        <Text
          style= {{"fontSize":16,"backgroundColor":"#8fd158","textAlign":"center","top":"7%","left":"0%", "width": "100%"}}
        > {Colleges[1]["Suggestions for College"]} </Text>

        <Text
          style= {{"top":"7%","fontSize":16,"backgroundColor":"#8fd158","textAlign":"center"}}
        ...
        <Text
          style= {{"backgroundColor":"#8fd158","fontSize":16,"textAlign":"center","top":450.92,"left":-0.4399999999999977}}
