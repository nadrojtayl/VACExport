...
function unwrap_dynamically(value,default_value){
 ...
 class GRAU extends React.Component {
    ...
    render(){ 
      ...
      <Image
        style= {[{width:"20%",height:"20%"}, {"rotate":"\"90deg\"","source":"https://img.gfinityesports.com/upload/_resized/640x0-nc/Modern_Warfare/5_56.jpg","height":"60%","top":"16.44%","left":"-16.439999999999998%","width":"130%"}]}
        source = {{uri:'https://img.gfinityesports.com/upload/_resized/640x0-nc/Modern_Warfare/5_56.jpg'}}
      >
      </Image>
        </View>
        )
