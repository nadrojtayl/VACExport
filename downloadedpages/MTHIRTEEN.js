...
function unwrap_dynamically(value,default_value){
 ...
 class MTHIRTEEN extends React.Component {
    ...
    render(){ 
      ...
      <Image
        style= {[{width:"20%",height:"20%"}, {"source":"https://img.gfinityesports.com/upload/_resized/640x360-nc/_other/class-2-m13.png","rotate":"\"90deg\"","top":"17.799999999999997%","left":"-14.46%","height":"60%","width":"130%"}]}
        source = {{uri:'https://img.gfinityesports.com/upload/_resized/640x360-nc/_other/class-2-m13.png'}}
      >
      </Image>
        </View>
        )
