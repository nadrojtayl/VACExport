...
function unwrap_dynamically(value,default_value){
 ...
 class SCAR extends React.Component {
    ...
    render(){ 
      ...
      <Image
        style= {[{width:"20%",height:"20%"}, {"top":"18.93%","left":"-9.33%","rotate":"\"90deg\"","height":"60%","source":"https://img.gfinityesports.com/upload/_resized/640x360-nc/_other/class-2-scar.png","width":"120%"}]}
        source = {{uri:'https://img.gfinityesports.com/upload/_resized/640x360-nc/_other/class-2-scar.png'}}
      >
      </Image>
