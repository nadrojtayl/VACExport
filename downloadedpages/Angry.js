...
<Text
          style= {[{position:'absolute'},{"top":"35.18%","left":"0.46%","innerText":"  angry[appData.index].Quote;"}]}
        > {  angry[appData.index].Quote} </Text>
        
<Text
          style= {[{position:'absolute'},{"top":"39.12%","left":"63.55%","innerText":" angry[appData.index].Author;"}]}
        > { angry[appData.index].Author} </Text>
