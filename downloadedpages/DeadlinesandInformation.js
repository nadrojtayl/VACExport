  ...
  renderElement(name,int, additionalStyle, clickfunctions,elem){
    ...
    render(){
      ...
      <Text
          ...
          {'If you need to buy something for college life, or you want some more in depth information, click on the links below'} </Text>
      <TouchableOpacity
        ...
        ><Text>{Colleges[6]["Websites"]}</Text>
         ...
         <TouchableOpacity
          ...
          style= {[{
            ...
            flexDirection: 'row',
            position:'absolute',alignItems:'center',justifyContent:'center', height: "7%", borderColor: 'gray', color:'black',
             borderRadius:15, borderWidth: 1,"top":"7`2%","fontSize":20,"width":"100%",}]}
