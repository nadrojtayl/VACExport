...
function unwrap_dynamically(value,default_value){
 ...
 class FourthPage extends React.Component {
    ...
    render(){ 
      ...
      <Text
          style= {[{position:'absolute'},{"top":"5.12%","left":"-0.04%","borderStyle":"solid","textAlign":"center","innerText":"'nail inspo'","backgroundColor":"pink","color":"purple"}]}
        > {'nail inspo'} </Text>
      ...
      <Image
        style= {[{width:"20%",height:"20%"}, {"top":"19.6%","left":"34.92%","source":" hairstyles[appData.index][\"nail link\"];"}]}
      ...
      <Image
        style= {[{width:"20%",height:"20%"}, {"top":"15.76%","left":"37.36%","source":" hairstyles[appData.index][\"nail link\"];"}]}
        source = {{uri: hairstyles[appData.index]["nail link"]}}
      >
      </Image>
      ...
      <Image
        style= {[{width:"20%",height:"20%"}, {"top":"23.85%","left":"37.63%","source":"  hairstyles[appData.nailindex][\"nail link\"];"}]}
        source = {{uri:  hairstyles[appData.nailindex]["nail link"]}}
      >
      </Image>
      ...
      <Image
        style= {[{width:"20%",height:"20%"}, {"top":"14.91%","left":"10.8%","source":"   hairstyles[appData.inspo][\"nail link\"];","height":345,"width":300}]}
