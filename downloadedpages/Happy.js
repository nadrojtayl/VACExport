...
<Text
          style= {[{position:'absolute'},{"innerText":"  happy[appData.index].Quote;","top":"36.17%","left":"1.73%"}]}
        > {  happy[appData.index].Quote} </Text>
        
<Text
          style= {[{position:'absolute'},{"top":"42.06%","left":"20.48%","innerText":"  happy[appData.index].Author;"}]}
        > {  happy[appData.index].Author} </Text>
