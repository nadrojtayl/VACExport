 ...
 class Settings extends React.Component {
    ...
    render(){ 
      ...
      <Switch
        ...
        ></Switch>
<Text
          style= {[{position:'absolute'},{"top":"35.59%","left":"43.65%","innerText":"'Audio'"}]}
        > {'Audio'} </Text>
        
<Text
          style= {[{position:'absolute'},{"top":"34.8%","left":"43.65%","innerText":"'Audio'"}]}
        > {'Audio'} </Text>
        
<Text
          style= {[{position:'absolute'},{"top":"34.54%","left":"45.43%","innerText":"'\"Audio\"'"}]}
        > {'"Audio"'} </Text>
