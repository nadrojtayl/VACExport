...
function unwrap_dynamically(value,default_value){
 ...
 class FAL extends React.Component {
    ...
    render(){ 
      ...
      <Image
        style= {[{width:"20%",height:"20%"}, {"rotate":"\"90deg\"","source":"https://img.gfinityesports.com/upload/_resized/640x360-nc/_other/class-1-fal.png","top":"23.32%","left":"-14.509999999999998%","height":"50%","width":"130%"}]}
        source = {{uri:'https://img.gfinityesports.com/upload/_resized/640x360-nc/_other/class-1-fal.png'}}
      >
      </Image>
