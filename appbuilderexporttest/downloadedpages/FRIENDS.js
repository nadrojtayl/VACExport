      ...
      <View style = {{width:"100%", height:"100%", borderWidth:5, borderColor:"black", backgroundColor:"pink"}}>
       <TouchableOpacity
          ...
          style= {[{
            ...
            height:"7%",
            width:"30%",
            position:'absolute',top:0,left:0, backgroundColor:'#8fd158', alignItems:'center',justifyContent:'center', height: "7%",  title:'Test', borderColor: 'gray', color:'black', borderRadius:15, borderWidth: 1},{"innerText":"'BACK '","height":25,"width":50,"top":"87.99%","left":"82.55%","fontSize":"resizeFont(12)"}]}
        >
...
<Text
          style= {[{position:'absolute',zIndex:100,width:'100%'},{"innerText":"'____________________________________________________________'","color":"#204016","top":"3.78%","left":"3.5%"}]}
        > {'____________________________________________________________'} </Text>
        
<Text
          style= {[{position:'absolute',zIndex:100,width:'100%'},{"innerText":null,"fontSize":"resizeFont(20)","color":"#204016"}]}
        > {null} </Text>
        
<Text
          style= {[{position:'absolute',zIndex:100,width:'100%'},{"innerText":"'FRIENDS'","color":"#204016","fontSize":"resizeFont(20)","top":"0.82%","left":"4.77%"}]}
        > {'FRIENDS'} </Text>
