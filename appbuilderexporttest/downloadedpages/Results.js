...
function unwrap_dynamically(value,default_value){
 ...
 class Results extends React.Component {
    ...
    render(){ 
      ...
      <Picker
        value={that.state["Resultspicker0"]}
        style= {{"top":"3.81%","left":"30.71%","options":"appData.SportOptions","repeateronPress":"appData.PlayerResults = filter_list_of_objs(Sports,elem.Sport,appData.Resultspicker0);","source":null,"repeaterbackgroundColor":"white","backgroundColor":"white","innerText":null,"color":"green","borderColor":"green"}}
        onValueChange={function(val){that.setState({Resultspicker0: val})}}  
      > 
        <Picker.Item label={"Select"} value={"Select"} />
        <Picker.Item label={"Option1"} value={"Option1"} />
        <Picker.Item label={"Baseball"} value={"Baseball"} /><Picker.Item label={"Hockey"} value={"Hockey"} /><Picker.Item label={"Tennis"} value={"Tennis"} /><Picker.Item label={"Basketball"} value={"Basketball"} /><Picker.Item label={"Cricket"} value={"Cricket"} /><Picker.Item label={"Football"} value={"Football"} />
      </Picker>
<Text
          style= {[{position:'absolute'},{"innerText":null,"top":"30.32%","left":"7.97%"}]}
        > {null} </Text>
        
<Multiplier
      goTo = {that.props.goTo}
      type = {"text"}
      data = {appData.filtered_list}
      style = {[{alignItems:'center'},{"top":"13.86%","left":"0.59%","color":"black","options":"appData.filtered_list","repeaterinnerText":"elem.Player","backgroundColor":"white"}]}
 ...
 <TouchableOpacity
          ...
          style= {[{
            ...
            flexDirection: 'row',
            width:"30%",
            position:'absolute',top:0,left:0, backgroundColor:'#8fd158', alignItems:'center',justifyContent:'center', height: "7%",  title:'Test', borderColor: 'gray', color:'black', borderRadius:15, borderWidth: 1},{"top":"91.15%","left":"68.69%","innerText":"'Go home'","backgroundColor":"black","color":"white"}]}
        >
