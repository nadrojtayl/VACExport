      ...
      <View style = {{width:"100%", height:"100%", borderWidth:5, borderColor:"black", backgroundColor:"white"}}>
       <TouchableOpacity
          ...
          style= {[{
            ...
            height:"7%",
            width:"30%",
            position:'absolute',top:0,left:0, backgroundColor:'#8fd158', alignItems:'center',justifyContent:'center', height: "7%",  title:'Test', borderColor: 'gray', color:'black', borderRadius:15, borderWidth: 1},{"top":"88.49%","left":"35.34%","innerText":"'Back'"}]}
        >
...
<Text
        ...
        style= {{fontSize:resizeFont(40), marginTop:'10%'}}
        
      > {"Tips on " + appData.selectedCondition}
       </Text>
