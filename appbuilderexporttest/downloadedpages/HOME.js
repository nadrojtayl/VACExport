...
function unwrap_dynamically(value,default_value){
    ...
    render(){ 
      ...
      <View style = {{width:"100%", height:"100%", borderWidth:5, borderColor:"black", backgroundColor:"pink"}}>
       <TouchableOpacity
          ...
          onPress = { function(){that.props.goTo('CREATE');; that.forceUpdate(); }}  
          style= {[{
            ...
            {"backgroundColor":"#204016","innerText":"'CREATE'","color":"pink","borderWidth":1,"borderStyle":"dashed","top":"23.17%","left":"16.64%","width":250,"fontWeight":"Bold","height":100,"fontSize":"resizeFont(50)"}]}
        >
 ...
 <TouchableOpacity
          ...
          style= {[{
            ...
            height:"7%",
            width:"30%",
            position:'absolute',top:0,left:0, backgroundColor:'#8fd158', alignItems:'center',justifyContent:'center', height: "7%",  title:'Test', borderColor: 'gray', color:'black', borderRadius:15, borderWidth: 1},{"backgroundColor":"#204016","innerText":"'VIEW'","color":"pink","borderWidth":1,"borderStyle":"dashed","top":"48.16%","left":"16.13%","width":250,"fontWeight":"Bold","height":100,"fontSize":"resizeFont(50)"}]}
        >
        <Text style = {{color:"pink"}}>
 ...
 <TouchableOpacity
          ...
          onPress = { function(){appData.profiles = Data_Profiles;
...
; that.forceUpdate(); }}  
          style= {[{
            ...
            width:"30%",
            position:'absolute',top:0,left:0, backgroundColor:'#8fd158', alignItems:'center',justifyContent:'center', height: "7%",  title:'Test', borderColor: 'gray', color:'black', borderRadius:15, borderWidth: 1},
            {"backgroundColor":"#204016","innerText":"'LOG OUT'","color":"pink","borderWidth":1,"borderStyle":"dashed","top":"66.94%","left":"16.19%","width":250,"fontWeight":"Bold","height":45,"fontSize":"resizeFont(20)"}]}
        >
        <Text style = {{color:"pink"}}>
...
<Text
          ...
          {"innerText":"'RIDDLE ME THIS'","top":"5.32%","left":"3.85%","color":"#204016","fontSize":35,"fontWeight":"bold"}]}
        > {'RIDDLE ME THIS'} </Text>
        
<Text
          style= {[{position:'absolute',zIndex:100,width:'100%'},{"innerText":"'____________________________________________________________'","top":"8.4%","left":"4.45%","color":"#204016"}]}
        > {'____________________________________________________________'} </Text>
        
 <TouchableOpacity
          
          onPress = { function(){that.props.goTo('TUTORIAL');; that.forceUpdate(); }}  
          style= {[{
            shadowColor: 'rgba(0,0,0, .4)', // IOS
            shadowOffset: { height: 1, width: 1 }, // IOS
            shadowOpacity: 1, // IOS
            ...
            width:"30%",
            position:'absolute',top:0,left:0, backgroundColor:'#8fd158', alignItems:'center',justifyContent:'center', height: "7%",  title:'Test', borderColor: 'gray', color:'black', borderRadius:15, borderWidth: 1},
            {"backgroundColor":"#204016","innerText":"'TUTORIAL'","color":"pink","borderWidth":1,"borderStyle":"dashed","top":"35.8%","left":"16.13%","width":250,"fontWeight":"Bold","height":100,"fontSize":"resizeFont(20)"}]}
        >
        <Text style = {{color:"pink"}}>
      ...
      <Image
        style= {[{width:"20%",height:"20%"}, {"source":"https://i.postimg.cc/sf02McrR/My-Post-4.png","width":"100%","top":"81.66%","left":"0.17%","height":"20%"}]}
