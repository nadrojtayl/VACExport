...
function unwrap_dynamically(value,default_value){
 ...
 class Boston extends React.Component {
    ...
    render(){ 
      ...
      <Text
          style= {[{position:'absolute',zIndex:100,width:'100%'},{"top":"10.06%","left":"25.23%","fontSize":"resizeFont(27)","innerText":"'Boston Marathon'"}]}
...
<Text
 ...
 <TouchableOpacity
      ...
      <Image
        style= {[{width:"20%",height:"20%",position:'absolute'}, {"top":"40.37%","left":"-3.01%","width":"103%","height":"60%","source":"https://i.ytimg.com/vi/7giAh7sh5BY/maxresdefault.jpg"}]}
