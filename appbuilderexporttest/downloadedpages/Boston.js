...
function unwrap_dynamically(value,default_value){
 ...
 class Boston extends React.Component {
    ...
    render(){ 
      ...
      <Text
          style= {[{ position:'absolute', textAlign:'center', zIndex:100,width:'100%'},{"top":"10.06%","left":"0%","fontSize":resizeFont(27),"innerText":"'Boston Marathon'"}]}
        > {'Boston Marathon'} </Text>
        
<Text
          style= {[{position:'absolute',zIndex:100,width:'100%'},{"top":"26.51%","left":"1.06%","innerText":"'The 2020 Boston Marathon is completly canceled and does not look like it is going to be rescheduled'"}]}
        > {'The 2020 Boston Marathon is completly canceled and does not look like it is going to be rescheduled'} </Text>
 ...
 <TouchableOpacity
      ...
      <Image
        style= {[{width:"20%",height:"20%",position:'absolute'}, {"top":"40.37%","left":"0%","width":"100%","height":"60%","source":"https://i.ytimg.com/vi/7giAh7sh5BY/maxresdefault.jpg"}]}
        source = {{uri:'https://i.ytimg.com/vi/7giAh7sh5BY/maxresdefault.jpg'}}
...
<Text
          style= {[{position:'absolute',zIndex:100,width:'100%'},{"top":"18.75%","left":"32.34%","innerText":"   appData.timer + \" seconds until refresh\";"}]}
