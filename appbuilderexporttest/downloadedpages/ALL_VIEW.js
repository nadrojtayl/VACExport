...
function unwrap_dynamically(value,default_value){
 ...
 class ALL_VIEW extends React.Component {
...
<Text
          style= {[{position:'absolute',zIndex:100,width:'100%'},{"innerText":"'ALL RIDDLES'","fontSize":30,"color":"#204016","top":"4.37%","left":"6.04%"}]}
        > {'ALL RIDDLES'} </Text>
 ...
 <TouchableOpacity
          ...
          onPress = { function(){
            appData.index ++;
            appData.opacity = 0;
            if (appData.index > Data_Riddles.length - 1){
              appData.index = 0;
            }; 
            that.forceUpdate(); 
          }}  
...
<Text
          style= {[{position:'absolute',zIndex:100,width:'100%'},{"top":"15.47%","left":"0.68%","innerText": "Data_Riddles[appData.index]['Riddle'];","color":"#204016","fontSize":20,"textAlign":"center","width":"100%"}]}
        > {      Data_Riddles[appData.index]['Riddle']} </Text>
        
 <TouchableOpacity
          
          onPress = { function(){
            if(appData.opacity > 0){
              appData.opacity = 0;
            } else {
              appData.opacity = 1;
            }; 
...
<Text
          ...
          {"top":"24.38%","left":"35.62%","color":"#204016","fontSize":"resizeFont(17)","innerText":"  'By ' + Data_Riddles[appData.index]['Owner'];","textAlign":"Center"}]}
        > {  'By ' + Data_Riddles[appData.index]['Owner']} </Text>
        
<Text
          style= {[{position:'absolute',zIndex:100,width:'100%'},
          {"top":"34%","left":"0.42%","innerText":" Data_Riddles[appData.index]['Answer'];","fontSize":20,"color":"#204016","opacity":appData.opacity,"textAlign":"center"}]}
        > { Data_Riddles[appData.index]['Answer']} </Text>
        
<Text
          style= {[{position:'absolute',zIndex:100,width:'100%'},{"top":"29.47%","left":"19.45%","innerText":"'________________________________________'","color":"#204016"}]}
        > {'________________________________________'} </Text>
        
<Text
          style= {[{position:'absolute',zIndex:100,width:'100%'},{"top":"37.79%","left":"19.71%","innerText":"'________________________________________'","color":"#204016"}]}
        > {'________________________________________'} </Text>
        
<Text
          style= {[{position:'absolute',zIndex:100,width:'100%'},{"top":"63.52%","left":"9.04%","innerText":"'Use the previous and next buttons to switch between questions. Use the answer button to show and hide the answer.'","textAlign":"center","width":"85%","fontSize":"resizeFont(17)"}]}
