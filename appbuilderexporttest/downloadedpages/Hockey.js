      ...
      <View style = {{width:"100%", height:"100%", borderWidth:5, borderColor:"black", backgroundColor:"white"}}>
       <TouchableOpacity
          ...
          style= {[{
            ...
            flexDirection: 'row',
            width:"30%",
            position:'absolute',top:0,left:0, backgroundColor:'#8fd158', alignItems:'center',justifyContent:'center', height: "7%",  title:'Test', borderColor: 'gray', color:'black', borderRadius:15, borderWidth: 1},{"top":"92.14%","left":"68.4%","color":"black","innerText":"'Hockey'","opacity":1,"borderStyle":"enum","backgroundColor":"white","borderColor":"black","borderWidth":10}]}
        >
