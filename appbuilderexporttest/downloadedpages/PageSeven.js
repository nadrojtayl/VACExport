...
function unwrap_dynamically(value,default_value){
 ...
 class PageSeven extends React.Component {
    ...
    render(){ 
      ...
      <Text
          style= {[{zIndex:100,width:'100%'},{"innerText":"'Anxiety '", marginTop: "40%","fontSize":"resizeFont(25)"}]}
        > {
`
Anxiety \n 
characterized by feelings of worry, anxiety, or fear that are strong
          \n\n
Depression
conditions associated with the lowering of a persons mood
...
person has difficulty recovering after experiencing or witnessing a terrifying event.
 ...
 <TouchableOpacity
          ...
          style= {[{
            ...
            height:"7%",
            width:"30%",
            position:'absolute',top:0,left:0, backgroundColor:'#8fd158', alignItems:'center',justifyContent:'center', height: "7%",  title:'Test', borderColor: 'gray', color:'black', borderRadius:15, borderWidth: 1},{"innerText":"'Resource Information '","top":"5.02%","left":"25.92%","width":200}]}
        >
