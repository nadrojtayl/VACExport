...
function unwrap_dynamically(value,default_value){
 ...
 class Username extends React.Component {
    ...
    render(){ 
      ...
      <TextInput
       style= {[{width:"60%", height:"5%", width:'60%', backgroundColor:'white',borderColor:'grey',borderWidth:1},{"top":"37.93%","left":"29.92%","borderRadius":5}]}
        value={that.state["Usernameinput0"]}
        onChangeText={function(val){that.setState({Usernameinput0: val});  
       }
       }
        />
<Text
          style= {[{position:'absolute',zIndex:100,width:'100%'},{"top":"25.03%","left":"19.76%","innerText":"'Enter your username:'","fontSize":40}]}
