...
function unwrap_dynamically(value,default_value){
 ...
 class MyHome extends React.Component {
    ...
    render(){ 
      ...
      <View
        style= {[{position:'absolute',zIndex:-1000, height:'10%',width:'10%'},{"backgroundColor":"#5F3A0D","width":550,"top":248.192,"left":5.813500000000033,"height":25}]}
        ></View>
<Text
          style= {[{position:'absolute',zIndex:100,width:'100%'},{"fontFamily":"Arial","innerText":"'My Home'","fontSize":75,"top":27.192000000000007,"left":139.81350000000003}]}
        > {'My Home'} </Text>
        
<View
        style= {[{position:'absolute',zIndex:-1000, height:'10%',width:'10%'},{"height":25,"width":550,"backgroundColor":"#5F3A0D","top":"56.69%","left":"0.86%"}]}
        ></View>
<View
        style= {[{position:'absolute',zIndex:-1000, height:'10%',width:'10%'},{"height":25,"width":550,"backgroundColor":"#5F3A0D","top":"82.61%","left":"0.68%"}]}
        ></View>



      <Image
        style= {[{width:"20%",height:"20%"}, {"source":"https://o.remove.bg/downloads/6334be7c-a064-4de7-a1c7-96f821ff5366/image-removebg-preview.png","zIndex":"transparent","backgroundColor":"transparent","top":"55.02%","left":"84.12%","height":25}]}
        source = {{uri:'https://o.remove.bg/downloads/6334be7c-a064-4de7-a1c7-96f821ff5366/image-removebg-preview.png'}}
      >
      </Image>
      ...
      <Image
        style= {[{width:"20%",height:"20%"}, {"source":"https://o.remove.bg/downloads/08b64fb8-cffe-46c8-addb-cd932ef02416/arrow-vector-icon-260nw-275278241-removebg-preview.png","backgroundColor":"transparent","top":"-7.14%","left":"-0.39%"}]}
        source = {{uri:'https://o.remove.bg/downloads/08b64fb8-cffe-46c8-addb-cd932ef02416/arrow-vector-icon-260nw-275278241-removebg-preview.png'}}
      >
      </Image>
