    ...
    render(){ 
      ...
      <Text
          style= {[{position:'absolute',zIndex:100,width:'100%'},{
            "innerText":"'My Grants'","color":"orange","fontWeight":"bold","fontSize":"resizeFont(20)",
          "top":"5%","left":155.16250000000002}]}
        > {'My Grants'} </Text>
...
<TextInput
       ...
       backgroundColor:'white',borderColor:'grey',borderWidth:1},{"width":"100%","top":"9%","left":0}]}
