...
; that.forceUpdate(); }}  
 ...
 <TouchableOpacity
          ...
          onPress = { function(){if(appData.X === 330){
    appData.X = appData.X - 230
}; that.forceUpdate(); }}  
          style= {[{
            shadowColor: 'rgba(0,0,0, .4)', // IOS
...
if(0.5>Math.random()){
    appData.spawned ++;
   var lid = createElement("image", { "top": 100, "left": "65%" ,"resizeMode":"contain","backgroundColor":"tranparent", "source":"https://i.imgur.com/SGCjjSN.gif", "zIndex":-10000000})
   appData.enemies.push(lid)
} else {
    appData.spawned ++;
    var lid = createElement("image", { "top": 100, "left": "20%" ,"resizeMode":"contain","backgroundColor":"tranparent", "source":"https://i.imgur.com/SGCjjSN.gif", "zIndex":-10000000})
    appData.enemies.push(lid)
}
removeOffScreen();
`,6000);
