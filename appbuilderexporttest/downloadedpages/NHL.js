...
function unwrap_dynamically(value,default_value){
 ...
 class NHL extends React.Component {
    ...
    render(){ 
      ...
      <Text
          style= {[{position:'absolute',zIndex:100,width:'100%'},{"top":"11.77%","left":"0%","innerText":"'NHL'","fontSize":resizeFont(27), textAlign:'center'}]}
        > {'NHL'} </Text>
...
<Text
          style= {[{position:'absolute',zIndex:100,width:'100%'},{"top":"31.88%","left":"4.85%","innerText":"'The beloved sport is supposed to reschedule on August 1st.  '"}]}
        > {'The beloved sport is supposed to reschedule on August 1st.  '} </Text>
 ...
 <TouchableOpacity
      ...
      <Image
        style= {[{width:"20%",height:"20%",position:'absolute'}, {"top":"45.82%","left":"-1.1%","height":"55%","width":"105%","source":"https://tse3.mm.bing.net/th?id=OIP.t5buIgT0DWzFWSdWtiQzBAHaEK&pid=Api&P=0&w=330&h=186"}]}
        source = {{uri:'https://tse3.mm.bing.net/th?id=OIP.t5buIgT0DWzFWSdWtiQzBAHaEK&pid=Api&P=0&w=330&h=186'}}
...
<Text
          style= {[{position:'absolute',zIndex:100,width:'100%'},{"top":"24.04%","left":"31.39%","innerText":"   appData.timer + \" seconds until refresh\";"}]}
